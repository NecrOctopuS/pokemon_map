# Generated by Django 2.2.3 on 2019-11-07 07:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0004_auto_20191107_1001'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='next_evolutions', to='pokemon_entities.Pokemon', verbose_name='из кого жволюционировал'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title',
        ...
        migrations.AlterField(
            ...
            name='appeared_at',
            field=models.DateTimeField(default=None, verbose_name='появился'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='defence',
